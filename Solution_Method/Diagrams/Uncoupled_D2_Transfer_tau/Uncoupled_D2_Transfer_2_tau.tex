...
\begin{tikzpicture}
	...
	\addplot[dashed, green, legend entry=Modified Euler] table[x=time, y=d2_me] {uc_me_diameter_2_transfer_time_step_tau.txt};
	\addplot[dotted, blue, legend entry=Fourth-order Runge-Kutta] table[x=time, y=d2_rk] {uc_rk_diameter_2_transfer_time_step_tau.txt};
	\end{axis}
\end{tikzpicture}
\end{document}