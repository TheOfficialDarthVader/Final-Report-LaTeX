...
\begin{tikzpicture}
	...
	\addplot[blue, legend entry=Analytic solution] table[x=time, y=d2_an] {d2_transfer_time_step_5.txt};
	\addplot[only marks, green, legend entry=Numerical solution] table[x=time, y=d2_num] {d2_transfer_time_step_5.txt};
	\end{axis}
\end{tikzpicture}
\end{document}