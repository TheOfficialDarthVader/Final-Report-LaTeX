...
\begin{tikzpicture}
	...
	\addplot[yellow, legend entry=Forward Euler] table[x=timestep_tau, y=fe_error] {UC_D2_Convergence_2.txt};
	\addplot[dashdotted, red, legend entry=Backward Euler] table[x=timestep_tau, y=be_error] {UC_D2_Convergence_2.txt};
	\addplot[dotted, green, legend entry=Modified Euler] table[x=timestep_tau, y=me_error] {UC_D2_Convergence_2.txt};
